    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setButton(AlertDialog.BUTTON_POSITIVE, "Add", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                String athleteName = editTextAnimalName.getText().toString();
                String athleteHabitat = editTextAnimalHabitat.getText().toString();
                String athleteDiet = editTextAnimalDiet.getText().toString();

                if (athleteName.isEmpty() || athleteHabitat.isEmpty() || athleteDiet.isEmpty()
                ) {
